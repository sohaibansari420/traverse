                                ...
                                <div class="header-info2 d-flex align-items-center">
                                    <div class="d-flex align-items-center sidebar-info">
                                        <div>
                                            ...
                                            <span class="d-block text-end">{{ auth()->user()->username }}</span>
                                        </div>
                                    </div>
                                    <img src="{{ getImage('assets/images/user/profile/' . auth()->user()->image, '350x300') }}" alt="">
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end" style="">
                                <a href="{{ route('user.profile-setting') }}" class="dropdown-item ai-icon ">
                                ...
                                <a href="{{ route('user.kyc.verify') }}" class="dropdown-item ai-icon ">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
