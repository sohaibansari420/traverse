            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.plan*') }}">
                    <a href="{{ route('admin.plan') }}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Options')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.wallet*') }}">
                    <a href="{{ route('admin.wallet') }}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Wallet')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.commission*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.commission.all') }} ">
                                <a href="{{ route('admin.commission.all') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Commission')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.commission.release') }} ">
                                <a href="{{ route('admin.commission.release') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Commission Release')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.commission.detail') }} ">
                                <a href="{{ route('admin.commission.detail') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Commission Detail')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.ranks*') }}">
                    <a href="{{ route('admin.ranks') }}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Ranks')</span>
                    </a>
                </li>
                
                

                <li class="sidebar-menu-item {{ menuActive('admin.media*') }}">
                    <a href="{{ route('admin.media') }}" class="nav-link ">
                        <i class="menu-icon las la-photo-video"></i>
                        <span class="menu-title">@lang('Media')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.users*', 3) }}">
                        ...
                        @php
                            $verify = \App\Models\User::where('verify', 1)->count();
                        @endphp
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.users*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.users.kyc.all') }}">
                                <a href="{{ route('admin.users.kyc.all') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('KYC')</span>
                                    @if ($verify)
                                        <span class="menu-badge pill bg--primary ml-auto">{{ $verify }}</span>
                                    @endif
                                </a>
                            </li>
                ...
                @php
                    $paid = \App\Models\Deposit::where('status', 1)
                        ->whereRaw('Date(created_at) = CURDATE()')
                        ->count();
                    $unpaid = \App\Models\Deposit::where('status', 0)
                        ->whereRaw('Date(created_at) = CURDATE()')
                        ->count();
                @endphp
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.deposit*', 3) }}">
                        ...
                        @if (0 < $pending_deposits_count || 0 < $unpaid)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.deposit*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.all.pending') }} ">
                                <a href="{{ route('admin.deposit.all.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Unpaid Deposits')</span>
                                    @if ($unpaid)
                                        <span class="menu-badge pill bg--primary ml-auto">{{ $unpaid }}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.successful') }} ">
                                <a href="{{ route('admin.deposit.successful') }}" class="nav-link">
                                    ...
                                    @if ($paid)
                                        <span class="menu-badge pill bg--primary ml-auto">{{ $paid }}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.report*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.report.ranks.rankAchievers') }}">
                                <a href="{{ route('admin.report.ranks.rankAchievers') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rank Achievers')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item sidebar-dropdown {{ menuActive('admin.report.user.wallets')}}">
                                <a href="javascript:void(0)" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('User Wallets')</span>
                                </a>
                                <div class="sidebar-submenu {{ menuActive('admin.report.user.wallets*') }} ">
                                    <ul>
                                        <li class="sidebar-menu-item">
                                            <a href="{{ route('admin.report.user.wallets', 'all') }}" class="nav-link">
                                                <i class="menu-icon las la-dot-circle-d"></i>
                                                <i class="menu-icon las la-dot-circle"></i>
                                                <span class="menu-title">@lang('All Wallets')</span>
                                            </a>
                                        </li>
                                        @php $wls = App\Models\Wallet::all(); @endphp
                                        @foreach ($wls as $wl)
                                            <li class="sidebar-menu-item">
                                                <a href="{{ route('admin.report.user.wallets', $wl->id ) }}" class="nav-link">
                                                    <i class="menu-icon las la-dot-circle-d"></i>
                                                    <i class="menu-icon las la-dot-circle"></i>
                                                    <span class="menu-title">{{ $wl->name }}</span>
                                                </a>
                                            </li>
                                        @endforeach
                                    </ul>
                            ...
                            <li class="sidebar-menu-item sidebar-dropdown {{ menuActive('admin.report.plan.purchased')}}">
                                <a href="javascript:void(0)" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Purchased Plans')</span>
                                </a>
                                <div class="sidebar-submenu {{ menuActive('admin.report.plan.purchased*') }} ">
                                    <ul>
                                        <li class="sidebar-menu-item">
                                            <a href="{{ route('admin.report.plan.purchased', 'all') }}" class="nav-link">
                                                <i class="menu-icon las la-dot-circle-d"></i>
                                                <i class="menu-icon las la-dot-circle"></i>
                                        ...
                                        <li class="sidebar-menu-item">
                                            <a href="{{ route('admin.report.plan.purchased', 'paid') }}" class="nav-link">
                                                <i class="menu-icon las la-dot-circle-d"></i>
                                                <i class="menu-icon las la-dot-circle"></i>
                                        ...
                                        <li class="sidebar-menu-item">
                                            <a href="{{ route('admin.report.plan.purchased', 'sponsor') }}" class="nav-link">
                                                <i class="menu-icon las la-dot-circle-d"></i>
                                                <i class="menu-icon las la-dot-circle"></i>
                                                <span class="menu-title">@lang('Sponsor')</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="sidebar-menu-item sidebar-dropdown {{ menuActive('admin.report.transaction') }}">
                                <a href="javascript:void(0)" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Transaction Log')</span>
                                </a>
                                <div class="sidebar-submenu {{ menuActive('admin.report.transaction*') }} ">
                                    <ul>
                                        <li class="sidebar-menu-item">
                                        ...
                                        @foreach ($wls as $wl)
                                            <li class="sidebar-menu-item">
                                                <a href="{{ route('admin.report.wallets', $wl->id) }}" class="nav-link">
                                                    <i class="menu-icon las la-dot-circle-d"></i>
                                                    <i class="menu-icon las la-dot-circle"></i>
                                                    <span class="menu-title">{{ $wl->name }}</span>
                                                </a>
