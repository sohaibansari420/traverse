                                    ...
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            <input type="file" class="profilePicUpload" id="profilePicUpload1"
                                                accept=".png, .jpg, .jpeg, .svg" name="logo">
                                    ...
                                    <div class="thumb">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 mt-sm-0 mt-4">
                                                    <div class="profilePicPreview logoPicPrev logoPrev bg--dark"
                                                        style="background-image: url({{ getImage(imagePath()['logoIcon']['path'] . '/light_logo.png', '?' . time()) }})">
                                                        <button type="button" class="remove-image"><i
                                                                class="fa fa-times"></i></button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="avatar-edit">
                                            <input type="file" class="profilePicUpload" id="profilePicUpload3"
                                                accept=".png, .jpg, .jpeg" name="light_logo">
                                            <label for="profilePicUpload3" class="bg-primary">@lang('Select Light Logo') </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
