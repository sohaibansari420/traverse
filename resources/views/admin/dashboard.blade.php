            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
                <div class="dashboard-w1 bg--{{ $key + 1 }} b-radius--10 box-shadow">
                    ...
                    <div class="details">
                        <div class="numbers">
                            <span
                                class="amount">{{ getAmount(App\Models\UserWallet::where('wallet_id', $wallet->id)->sum('balance')) }}
                                {{ $wallet->currency }}</span>
                        </div>
                        <div class="desciption">
                            <span class="text--small">{{ $wallet->name }}</span>
                        </div>
                        <a href="{{ route('admin.report.wallet') }}?walletID={{ $wallet->id }}"
                            class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--3 b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <a href="{{ route('admin.report.bvLog') }}?type=rightBV"
                        class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
            ...
            <div class="row mb-none-30">
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--white">
                        ...
                        <div class="widget-three__content">
                            <h2 class="numbers">{{ getAmount($payment['total_deposit_amount']) }}
                                {{ $general->cur_text }}</h2>
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--white">
                        ...
                        <div class="widget-three__content">
                            <h2 class="numbers">{{ getAmount($payment['total_deposit_charge']) }}
                                {{ $general->cur_text }}</h2>
